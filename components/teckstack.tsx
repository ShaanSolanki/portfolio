...
import { 
  ...
  SiFlutter, SiExpress, SiMongodb, 
  SiFirebase, SiPostman, SiVercel, 
  SiThreedotjs 
} from 'react-icons/si';
...
const TechStack = () => {
  ...
  useEffect(() => {
    ...
    // Grid item animations with proper bounds checking
                ...
                {category.items.map((tech) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span className="text-xl sm:text-2xl text-indigo-300">
                        {tech.icon}
                      </span>
                      <div className="overflow-hidden">
                        <h4 className="font-medium text-white truncate">{tech.name}</h4>
                        <p className="text-xs font-mono text-indigo-300/70 mt-1 truncate">
                          {tech.label}
                        </p>
                      </div>
                    </div>
